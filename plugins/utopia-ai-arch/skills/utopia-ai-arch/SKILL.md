...
Each walkthrough is grounded in a specific failure mode caught by smoke-test audits of real production repos (qbt, jolly, tlumu). If [bootstrap-procedure.md][bootstrap-procedure] feels abstract, read [initial-setup.md][initial-setup] first — it puts concrete shape on the decisions Phase 0–3 expects you to make.
