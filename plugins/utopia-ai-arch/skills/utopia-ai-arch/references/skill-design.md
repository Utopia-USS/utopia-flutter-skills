...
A skill recommending `dart fix --apply` project-wide collides with WIP. Either scope it to changed files or remove the recommendation. See [drift-symptoms.md](drift-symptoms.md) for repoB's precedent.
