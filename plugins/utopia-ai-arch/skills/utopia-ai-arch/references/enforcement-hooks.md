...
❌ Adding a Dart MCP cleanup hook "in case the team has the same problem as jolly". Wait for the leak to be observed and measured. Until then it's premature optimization that runs every session-open.
