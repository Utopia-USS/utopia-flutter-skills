...
Precedent: explicitly rejected in `qbt-black-phone/.claude/docs/claude-architecture.md:123`, `jolly-phonics-apps/.claude/docs/claude-architecture.md:109-113`, `madrosc-tlumu/.claude/docs/claude-architecture.md:106-108` — all three repos removed their `PreToolUse` push-guard once the two existing layers were in place.
